...
เวลา 13:00 น. เป็นต้นไป หอประชุมปาริชาต มหาวิทยาลัยทักษิณ วิทยาเขตสงขลา</p>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="forms-curriculum.html">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="forms-teacher_developmant_avtivity.html">
          <i class="bi bi-person "></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="forms-budget.html">
          <i class="bi bi-journal-text"></i>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="forms-area_identitty.html">
