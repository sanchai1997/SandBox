        ...
        <div class="col-lg-9">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <form action="<?php echo base_url('edit_curriculum_school_competency');?>" method="POST" name="CurriculumCompetency" id="CurriculumCompetency" enctype="multipart/form-data"> 
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <select class="form-select" aria-label="Default select example" name="CompetencyCode" id="CompetencyCode">
                      <option  value="-1">เลือกสมรรถนะ</option>
