          ...
          <div class="card">
            <div class="card-body">
              ...
              <form>
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">สถานที่จัดกิจกรรม</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">หน่วยงานที่จัดกิจกรรม</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <label for="inputDate" class="col-sm-2 col-form-label">วันที่เริ่มกิจกรรม</label>
                  <div class="col-sm-10">
                ...
                <div class="row mb-3">
                    <label for="inputDate" class="col-sm-2 col-form-label">วันที่สิ้นสุดกิจกรรม</label>
                    <div class="col-sm-10">
                      <input type="date" class="form-control">
                    </div>
                </div>
