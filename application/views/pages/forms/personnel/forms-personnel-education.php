            ...
            <div class="col-lg-9">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="<?php echo base_url('add-personnel-education/' . $_GET['PersonnelID'] . '/' . $_GET['JurisdictionCode'] . '/' . $_GET['PersonnelTypeCode'] . '/' . $_GET['PositionCode']); ?>" method="POST" id="Personnel" enctype="multipart/form-data">
