                                ...
                                <?php if ($page == 'sh1') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="ชื่อเกณฑ์" name="CriteriaName">
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="CriteriaDescription"></textarea>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="จำนวนระดับของตัวชี้วัด" name="CriteriaLevelAmount">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="จำนวนระดับของตัวชี้วัด" name="CriteriaCompositionAmount">
                                                    <label for="Y"><?php echo nbs(
                                                                        2
                            ...
                            ");
                                    ...
                                    ?>
                                        ...
                                        <input type="hidden" name="UserName" value="<?php echo $UserName; ?>">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="รหัสตัวชี้วัด" name="CriteriaID" value="<?php echo $show->CriteriaID ?>">
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="ชื่อเกณฑ์" name="CriteriaName" value="<?php echo $show->CriteriaName ?>">
                                ...
                                <?php if ($page == 'sh2') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="หัวข้อระดับตัวชี้วัด" name="LevelName">
                                                <label for="Y"><?php echo nbs(
                                                                    2
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="คะแนนระดับตัวชี้วัด" name="LevelScore">
                                                <label for="Y"><?php echo nbs(
                                                                    2
                                ...
                                <?php if ($page == 'sh22') { ?>
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url(
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="หัวข้อระดับตัวชี้วัด" name="LevelName" value="<?php echo $show->LevelName ?>">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> หัวข้อระดับตัวชี้วัด </label>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="คะแนนระดับตัวชี้วัด" name="LevelScore" value="<?php echo $show->LevelScore ?>">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> คะแนนระดับตัวชี้วัด </label>
                                                </div>
                                ...
                                <?php if ($page == 'sh3') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="หัวข้อองค์ประกอบตัวชี้วัด" name="CompositionName">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="ค่าน้ำหนักการประเมินตัวชี้วัด" name="CompositionWeightScore">
                                                <label for="floatingName"><?php echo nbs(
                                                                                2
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url(
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="หัวข้อองค์ประกอบตัวชี้วัด" name="CompositionName" value="<?php echo $show->CompositionName ?>">
                                                        <label for="floatingName"><?php echo nbs(
                                                                                        2
                                                                                    ); ?> หัวข้อองค์ประกอบตัวชี้วัด </label>
                                                    </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="ค่าน้ำหนักการประเมินตัวชี้วัด" name="CompositionWeightScore" value="<?php echo $show->CompositionWeightScore ?>">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> ค่าน้ำหนักการประเมินตัวชี้วัด
                                                    </label>
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            ...
                                            $("#CriteriaID").change(function() {
                                                ...
                                                $("#CompositionIndex option[id='" + selectedCriteriaID + "']").show();
                                ...
                                <?php if ($page == 'sh5') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="ปีการศึกษาที่ทำกระประเมิน" name="SchoolAssessmentEducationYear">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
...
+ -->
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="ชื่อผู้ประเมิน" name="AssessmentorName">
                            ...
                            ");
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url(
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="ชื่อผู้ประเมิน" name="AssessmentorName" value="<?php echo $show->AssessmentorName ?>">
                                                    <label for="floatingName"><?php echo nbs(2); ?> ชื่อผู้ประเมิน </label>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                ...
                                <?php if ($page == 'sh8') { ?>
                                    ...
                                    <form action="<?php echo site_url('achie_ass_forms_up_p8'); ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="SchoolAssessmentName" placeholder="ชื่อการประเมิน" name="SchoolAssessmentName">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> ชื่อการประเมิน </label>
                                                </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="AssessmentorName" placeholder="ชื่อผู้ประเมิน" name="AssessmentorName">
                                                <label for="floatingName"><?php echo nbs(
                                                                                2
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url('achie_ass_edit_p8'); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="SchoolAssessmentName" placeholder="ชื่อการประเมิน" name="SchoolAssessmentName" value="<?php echo $show->SchoolAssessmentName ?>">
                                                        <label for="floatingName"><?php echo nbs(
                                                                                        2
                                                                                    ); ?> ชื่อการประเมิน </label>
                                                    </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="AssessmentorName" placeholder="ชื่อผู้ประเมิน" name="AssessmentorName" value="<?php echo $show->AssessmentorName ?>">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> ชื่อผู้ประเมิน </label>
                                                </div>
