                                        ...
                                        <div class="col">
                                            <div class="form-floating">
                                                <select class="form-control" id="floatingSelect"
                                                    aria-label="Floating label select example" name="SchoolID" onchange="updateInput(this)">
                                            ...
                                            <input type="hidden" id="myInput" name="SchoolID_index">
                                            <script>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id=""
                                                    ...
                                                    value="<?php echo $show->SEMESTER_NAME; ?>" disabled>
                                                <input type="hidden" class="form-control" id="SchoolAssessmentSemester"
                                                    placeholder="ภาคเรียนที่ทำการประเมิน"
                                                    name="SchoolAssessmentSemester"
                                                    value="<?php echo $show->SEMESTER_CODE; ?>">
                                                <input type="hidden" class="form-control" id="SchoolAssessmentSemester"
                                                    placeholder="ภาคเรียนที่ทำการประเมิน"
                                                    name="SchoolAssessmentSemester_index"
                                                    value="<?php echo $show->SEMESTER_NAME; ?>">
                                                <label for="floatingName"><?php echo nbs(
                                                                                        2
                                                                                    ); ?>
                                        ...
                                        <div class="col">
                                            <div class="form-floating">
                                                ...
                                                <input type="hidden" class="form-control" placeholder="" name="SchoolID"
                                                    value="<?php echo $SchoolID; ?>">
                                                <input type="hidden" class="form-control" placeholder=""
                                                    name="SchoolID_index" value="<?php echo $cls->SchoolNameThai; ?>">
                                                <?php } ?>
                                                <label for="floatingName"><?php echo nbs(
                                                                                        2
                                                                                    ); ?>
