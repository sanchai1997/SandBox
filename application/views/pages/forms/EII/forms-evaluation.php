                            ...
                            <div class="card-body">
                                ...
                                <?php if ($page == 'sh1') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="รหัสตัวชี้วัด" name="CriteriaID">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="ชื่อเกณฑ์" name="CriteriaName" required>
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="CriteriaDescription" required></textarea>
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="จำนวนระดับของตัวชี้วัด" name="CriteriaLevelAmount" required>
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="จำนวนระดับของตัวชี้วัด" name="CriteriaCompositionAmount" required>
                                                    <label for="Y"><?php echo nbs(
                                                                        2
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="จำนวนระดับของตัวชี้วัด" name="CriteriaPassingScorePercentage">
                                        ...
                                        <div class="text-center">
                                            <a href="Fm_evaluation_das_p1?page=sh1" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                            ...
                            ");
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url('ass_ria_edit_p1'); ?>" method="post">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="รหัสตัวชี้วัด" name="" value="<?php echo $show->CriteriaID ?>" disabled>

                                                        <input type="hidden" class="form-control" id="floatingName" placeholder="รหัสตัวชี้วัด" name="CriteriaID" value="<?php echo $show->CriteriaID ?>">

                                                        <input type="hidden" class="form-control" id="floatingName" placeholder="รหัสตัวชี้วัด" name="Id" value="<?php echo $show->Id ?>">
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="ชื่อเกณฑ์" name="CriteriaName" value="<?php echo $show->CriteriaName ?>" required>
                                                        <label for="Y"><?php echo nbs(2); ?> ชื่อเกณฑ์ </label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="CriteriaDescription"><?php echo $show->CriteriaDescription ?></textarea>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="จำนวนระดับของตัวชี้วัด" name="CriteriaLevelAmount" value="<?php echo $show->CriteriaLevelAmount ?>">
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="จำนวนระดับของตัวชี้วัด" name="CriteriaCompositionAmount" value="<?php echo $show->CriteriaCompositionAmount ?>">
                                                        <label for="floatingName"><?php echo nbs(2); ?>
                                                            จำนวนองค์ประกอบของตัวชี้วัด</label>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="จำนวนระดับของตัวชี้วัด" name="CriteriaPassingScorePercentage" value="<?php echo $show->CriteriaPassingScorePercentage ?>">
                                                        <label for="floatingName"><?php echo nbs(2); ?>
                                                            คะแนนการผ่านเกณฑ์(%)</label>
                                                    </div>
                                                </div>
                                ...
                                <?php if ($page == 'sh2') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="ตัวชี้วัด" name="" value="<?php echo $key ?>" disabled>
                                                    <input type="hidden" class="form-control" id="floatingName" placeholder="ตัวชี้วัด" name="index" value="<?php echo $key ?>">
                                                    <input type="hidden" class="form-control" id="floatingName" placeholder="" name="CriteriaID" value="<?php echo $Id ?>">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="LevelIndex">
                                                    ...
                                                    <label for="Y"><?php echo nbs(2); ?>ลำดับของระดับตัวชี้วัด</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="หัวข้อระดับตัวชี้วัด" name="LevelName" required>
                                                <label for="Y"><?php echo nbs(
                                                                    2
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="คะแนนระดับตัวชี้วัด" name="LevelScore" required>
                                                <label for="Y"><?php echo nbs(
                                                                    2
                                        ...
                                        <div class="text-center">
                                            <a href="Fm_evaluation_das_p1?page=sh1" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                                            <?php if ($k != '0') { ?>
                                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="float: right;">บันทึกข้อมูล</button> <?php } ?>
                                        </div>
                                ...
                                <?php if ($page == 'sh22') { ?>
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url(
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div class="form-floating">
                                                        ...
                                                        ?>
                                                            ...
                                                            <input type="hidden" class="form-control" id="floatingName" placeholder="ตัวชี้วัด" name="index" value="<?php echo $clsC->CriteriaID; ?>">
                                                            <input type="hidden" class="form-control" placeholder="รหัสตัวชี้วัด" name="CriteriaID" value="<?php echo $CriteriaID; ?>">
                                                        <?php } ?>
                                                        <label for="floatingName"><?php echo nbs(
                                                                                        2
                                                                                    ); ?>
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="floatingSelect"><?php echo nbs(2); ?>ลำดับของระดับตัวชี้วัด</label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="หัวข้อระดับตัวชี้วัด" name="LevelName" value="<?php echo $show->LevelName ?>" required>
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> หัวข้อระดับตัวชี้วัด </label>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="คะแนนระดับตัวชี้วัด" name="LevelScore" value="<?php echo $show->LevelScore ?>" required>
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> คะแนนระดับตัวชี้วัด </label>
                                                </div>
                                            ...
                                            <div class="text-center">
                                                <a href="Fm_evaluation_das_p1?page=sh1" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                                                <!-- ปุ่มลบ --> <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#del_com<?php echo $show->Id_acl; ?>"><i class="bi bi-trash"></i>
                                                </button> <!-- ปุ่มลบ -->
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal" style="float: right;">แก้ไขข้อมูล</button>
                                            </div>
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="del_com<?php echo $show->Id_acl; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <?php if ($page == 'sh3') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="ตัวชี้วัด" name="" value="<?php echo $key ?>" disabled>
                                                    <input type="hidden" class="form-control" id="floatingName" placeholder="ตัวชี้วัด" name="index" value="<?php echo $key ?>">
                                                    <input type="hidden" class="form-control" id="floatingName" placeholder="ตัวชี้วัด" name="CriteriaID" value="<?php echo $Id ?>">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="CompositionIndex">
                                                    ...
                                                    <label for="Y"><?php echo nbs(2); ?>ลำดับองค์ประกอบตัวชี้วัด</label>
                                                </div>
                                            </div>

                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="หัวข้อองค์ประกอบตัวชี้วัด" name="CompositionName" required>
                                                    <label for="Y"><?php echo nbs(
                                                                        2
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="number" class="form-control" id="floatingName" placeholder="ค่าน้ำหนักการประเมินตัวชี้วัด" name="CompositionWeightScore" step="0.01" required>
                                                <label for="Y"><?php echo nbs(
                                                                    2
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="หลักฐานประกอบการประเมินขององค์ประกอบตัวชี้วัด" name="CompositionGuideline">
                                                <label for="floatingName"><?php echo nbs(
                                                                                2
                                                                            ); ?>
                            ...
                            ");
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url(
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div class="form-floating">
                                                        ...
                                                        ?>
                                                            <input type="text" class="form-control" id="" placeholder="รหัสตัวชี้วัด" name="" value="<?php echo $clsC->CriteriaID; ?>" disabled>
                                                            <input type="hidden" class="form-control" id="floatingName" placeholder="ตัวชี้วัด" name="index" value="<?php echo $clsC->CriteriaID; ?>">
                                                            <input type="hidden" class="form-control" placeholder="รหัสตัวชี้วัด" name="CriteriaID" value="<?php echo $Id; ?>">
                                                        <?php } ?>
                                                        <label for="floatingName"><?php echo nbs(
                                                                                        2
                                                                                    ); ?>
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        ...
                                                        <label for="floatingSelect"><?php echo nbs(2); ?>ลำดับองค์ประกอบตัวชี้วัด</label>
                                                    </div>
                                                </div>

                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="หัวข้อองค์ประกอบตัวชี้วัด" name="CompositionName" value="<?php echo $show->CompositionName ?>" required>
                                                        <label for="floatingName"><?php echo nbs(
                                                                                        2
                                                                                    ); ?> หัวข้อองค์ประกอบตัวชี้วัด
                                                        </label>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="ค่าน้ำหนักการประเมินตัวชี้วัด" name="CompositionWeightScore" value="<?php echo $show->CompositionWeightScore ?>" step="0.01" required>
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> ค่าน้ำหนักการประเมินตัวชี้วัด
                                                    </label>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="หลักฐานประกอบการประเมินขององค์ประกอบตัวชี้วัด" name="CompositionGuideline" value="<?php echo $show->CompositionGuideline ?>">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?>
                                                        หลักฐานประกอบการประเมินขององค์ประกอบตัวชี้วัด
                                            ...
                                            <div class="text-center">
                                                <a href="Fm_evaluation_das_p1?page=sh1" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                                                <!-- ปุ่มลบ --> <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#del_com<?php echo $show->Id_acc; ?>"><i class="bi bi-trash"></i>
                                                </button> <!-- ปุ่มลบ -->
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal" style="float: right;">แก้ไขข้อมูล</button>
                                            </div>
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="del_com<?php echo $show->Id_acc; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">
                                ...
                                <?php if ($page == 'sh4') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <select class="form-select" id="LevelIndex" aria-label="Floating label select example" name="LevelIndex">
                                                        <option value="-1" selected>เลือก</option>
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <select class="form-select" id="CompositionIndex" aria-label="Floating label select example" name="CompositionIndex">
                                                        <option value="-1" selected>เลือก</option>
                                                        ...
                                                        foreach ($result->result() as $cls) {
                                                        ?>
                                                            <option id="<?= $cls->CriteriaID; ?>" value="<?= $cls->CompositionIndex; ?>">
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="คำอธิบายระดับของแต่ละองค์ประกอบ" name="CompositionLevelDescription" required>
                                                <label for="floatingName"><?php echo nbs(
                                                                                2
                            ...
                            ");
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url(
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="คำอธิบายระดับของแต่ละองค์ประกอบ" name="CompositionLevelDescription" value="<?php echo $show->CompositionLevelDescription ?>">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> คำอธิบายระดับของแต่ละองค์ประกอบ
                                                    </label>
                                            ...
                                            <div class="text-center">
                                                <a href="Fm_evaluation_das_p1?page=sh1" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                                                <!-- ปุ่มลบ --> <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#ass_ria_com_lvl_del_p4<?php echo $show->Id_accl; ?>"><i class="bi bi-trash"></i>
                                                </button> <!-- ปุ่มลบ -->
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal" style="float: right;">แก้ไขข้อมูล</button>
                                            </div>
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="ass_ria_com_lvl_del_p4<?php echo $show->Id_accl; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <?php if ($page == 'sh5') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="ปีการศึกษาที่ทำกระประเมิน" name="SchoolAssessmentEducationYear" required>
                                                    <label for="Y"><?php echo nbs(
                                                                                    2
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    ...
                                                    <label for="Y">ภาคเรียนที่ทำการประเมิน</label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="ชื่อการประเมิน" name="SchoolAssessmentName" required>
                                                <label for="Y"><?php echo nbs(
                                                                                2
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="SchoolAssessmentDescription"></textarea>
                                                <label for="floatingTextarea2"><?php echo nbs(2); ?>คำอธิบายการประเมิน</label>
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <a href="Fm_evaluation_das_p4?page=sh4" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url(
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="number" class="form-control" id="floatingName" placeholder="ปีการศึกษาที่ทำการประเมิน" name="" value="<?php echo $show->SchoolAssessmentEducationYear ?>" disabled>
                                                        <input type="hidden" class="form-control" id="floatingName" placeholder="ปีการศึกษาที่ทำการประเมิน" name="SchoolAssessmentEducationYear" value="<?php echo $show->SchoolAssessmentEducationYear ?>">
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="ชื่อการประเมิน" name="SchoolAssessmentName" value="<?php echo $show->SchoolAssessmentName ?>" required>
                                                    <label for="Y"><?php echo nbs(
                                                                                    2
                                                                                ); ?> ชื่อการประเมิน </label>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea2" style="height: 100px" name="SchoolAssessmentDescription"><?php echo $show->SchoolAssessmentDescription ?></textarea>
                                                    <label for="floatingTextarea2"><?php echo nbs(2); ?>คำอธิบายการประเมิน</label>
                                                </div>
                                            </div>
                                            <div class="text-center">
                                ...
                                <?php if ($page == 'sh6') { ?>
                                    ...
                                    <form action="<?php echo site_url(
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    <select class="form-select" id="SchoolAssessmentEducationYear" aria-label="Floating label select example" name="SchoolAssessmentEducationYear">
                                                        <option value="-1" selected>เลือก</option>
                                                        <?php
...
+ -->
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="floatingName" placeholder="ชื่อผู้ประเมิน" name="AssessmentorName" required>
                                                <label for="Y"><?php echo nbs(2); ?> ชื่อผู้ประเมิน </label>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="number" max="100" class="form-control" id="SchoolAssessmentScore" placeholder="คะแนน" name="SchoolAssessmentScore">
                                                <label for="floatingName"><?php echo nbs(2); ?> คะแนน </label>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <select class="form-select" id="SchoolAssessmentCode" aria-label="Floating label select example" name="SchoolAssessmentCode">
                                                    <option value="-1">เลือก</option>
                                                    <?php
                                    ...
                                    <input type="text" value="" name="SchoolAssessmentCode" id="SchoolAssessmentCode"> -->
                                        ...
                                        <div class="row mb-3">
                                            <div class="input-group mb-3">
                                                <label class="input-group-text" for="inputGroupFile01">ลิงก์เอกสารแนบรายละเอียดการประเมิน</label>
                                                <input type="file" class="form-control" id="inputGroupFile01" name="SchoolAssessmentAttachmentURL">
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <a href="Fm_evaluation_das_p5?page=sh5" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url(
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="ปีการศึกษาที่ทำการประเมิน" name="" value="<?php echo $show->SchoolAssessmentEducationYear ?>" disabled>
                                                    <input type="hidden" class="form-control" id="floatingName" placeholder="" name="SchoolAssessmentEducationYear" value="<?php echo $show->SchoolAssessmentEducationYear ?>">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?>
                                                        ปีการศึกษาที่ทำการประเมิน </label>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="floatingName" placeholder="ภาคเรียนที่ทำการประเมิน" name="" value="<?php echo $sum_name ?>" disabled>
                                                        <input type="hidden" class="form-control" id="floatingName" placeholder="ภาคเรียนที่ทำการประเมิน" name="SchoolAssessmentSemester" value="<?php echo $summer ?>">
                                                        <label for="Y"><?php echo nbs(
                                                                                        2
                                                ...
                                                <div class="col">
                                                    <div class="form-floating">
                                                        ...
                                                        foreach ($result->result() as $cls) {
                                                        ?>
                                                            <input type="text" class="form-control" id="floatingName" placeholder="ปีการศึกษาที่ทำการประเมิน" name="" value="<?php echo $cls->CriteriaID ?>" disabled>
                                                        <?php } ?>
                                                        <input type="hidden" class="form-control" id="floatingName" placeholder="" name="CriteriaID" value="<?php echo $show->CriteriaID ?>">
                                                        <label for="Y"><?php echo nbs(
                                                                                        2
                                                                                    ); ?>
                                                            ตัวชี้วัด </label>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="floatingName" placeholder="ชื่อผู้ประเมิน" name="AssessmentorName" value="<?php echo $show->AssessmentorName ?>" required>
                                                    <label for="Y"><?php echo nbs(2); ?> ชื่อผู้ประเมิน </label>
                                                </div>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="SchoolAssessmentScore" placeholder="คะแนน" name="SchoolAssessmentScore" value="<?php echo $show->SchoolAssessmentScore ?>">
                                                    <label for="floatingName"><?php echo nbs(2); ?> คะแนน </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="input-group mb-3">
                                                    <label class="input-group-text" for="inputGroupFile01">ลิงก์เอกสารแนบรายละเอียดการประเมิน</label>
                                                    <input type="file" class="form-control" id="inputGroupFile01" name="SchoolAssessmentAttachmentURL" value="<?php echo $show->SchoolAssessmentAttachmentURL ?>">
                                                </div>
                                            </div>
                                            <div class="text-center">
                                                <a href="Fm_evaluation_das_p5?page=sh5" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                                                <!-- ปุ่มลบ --> <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#del_com"><i class="bi bi-trash"></i>
                                                </button> <!-- ปุ่มลบ -->
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal" style="float: right;">แก้ไขข้อมูล</button>
                                            </div>
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="del_com" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">
                                ...
                                <?php if ($page == 'sh7') { ?>
                                    ...
                                    <form action="<?php echo site_url('sc_ass_res_forms_up_p7'); ?>" method="post" enctype="multipart/form-data" onsubmit="return checkSelectedOption()">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="number" class="form-control" id="floatingName" placeholder="ปีการศึกษาที่ทำการประเมิน" name="" value="<?php echo $year; ?>" disabled>
                                                    <input type="hidden" class="form-control" id="floatingName" placeholder="ปีการศึกษาที่ทำการประเมิน" name="SchoolAssessmentEducationYear" value="<?php echo $year; ?>">
                                                    <label for="floatingName"><?php echo nbs(2); ?>
                                                        ปีการศึกษาที่ทำการประเมิน
                                                    </label>
                                                </div>
                            ...
                            ");
                                    ...
                                    ');
                                            ...
                                            <div class="text-center">
                                                <a href="Fm_evaluation_das_p5?page=sh5" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                                                <!-- ปุ่มลบ --> <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#del_sar"><i class="bi bi-trash"></i>
                                                </button> <!-- ปุ่มลบ -->
                                                <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#exampleModal" style="float: right;">แก้ไขข้อมูล</button>
                                            </div>
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="del_sar" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">
                                ...
                                <?php if ($page == 'sh8') { ?>
                                    <!-- start Form ข้อมูลผลการประเมินตามตัวชี้วัด -->
                                    <form action="<?php echo site_url('achie_ass_forms_up_p8'); ?>" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col">
                                                <div class="form-floating">
                                                    ...
                                                    <label for="Y">ปีการศึกษาที่ทำการประเมิน</label>
                                                </div>
                                            </div>
                                            <div class="col">
                                                <div class="form-floating">
                                        ...
                                        <div class="row mb-3">
                                            <div class="col">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="SchoolAssessmentName" placeholder="ชื่อการประเมิน" name="SchoolAssessmentName" required>
                                                    <label for="Y"><?php echo nbs(
                                                                        2
                                                                    ); ?> ชื่อการประเมิน </label>
                                                </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="SchoolAssessmentDescription" placeholder="คำอธิบายการประเมิน" name="SchoolAssessmentDescription">
                                                <label for="floatingName"><?php echo nbs(
                                                                                2
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-floating">
                                                <input type="text" class="form-control" id="AssessmentorName" placeholder="ชื่อผู้ประเมิน" name="AssessmentorName" required>
                                                <label for="Y"><?php echo nbs(
                                                                    2
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="AchievementAssessmentPassingFlag" id="gridRadios1" value="0">
                                            ...
                                            <div class="col">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="AchievementAssessmentPassingFlag" id="gridRadios2" value="1">
                                        ...
                                        <script>
                                            // ตรวจสอบการเลือกตัวเลือกอย่างน้อยหนึ่งตัว
                                            function validateForm() {
                                                var radios = document.getElementsByName("AchievementAssessmentPassingFlag");
                                                var selected = false;
                                                ...
                                                if (!selected) {
                                                    alert("โปรดเลือกผลการประเมินผลสัมฤทธิ์การศึกษา");
                                                    return false;
                                                }
                                            }
                                        </script>
                                        <div class="row mb-3">
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="file" class="form-control" id="inputGroupFile01" name="AchievementAssessmentAttachmentURL">
                                            </div>
                                        </div>
                                        <div class="text-center">
                                            <a href="Fm_evaluation_das_p8?page=sh8" class="btn btn-danger" style="float: left;">ยกเลิก</a>
                                    ...
                                    ?>
                                        ...
                                        <form action="<?php echo site_url('achie_ass_edit_p8'); ?>" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" id="SchoolAssessmentName" placeholder="ชื่อการประเมิน" name="SchoolAssessmentName" value="<?php echo $show->SchoolAssessmentName ?>" required>
                                                        <label for="Y"><?php echo nbs(
                                                                                        2
                                                                                    ); ?> ชื่อการประเมิน </label>
                                                    </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="SchoolAssessmentDescription" placeholder="คำอธิบายการประเมิน" name="SchoolAssessmentDescription" value="<?php echo $show->SchoolAssessmentDescription ?>">
                                                    <label for="floatingName"><?php echo nbs(
                                                                                    2
                                                                                ); ?> คำอธิบายการประเมิน </label>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="form-floating">
                                                    <input type="text" class="form-control" id="AssessmentorName" placeholder="ชื่อผู้ประเมิน" name="AssessmentorName" value="<?php echo $show->AssessmentorName ?>" required>
                                                    <label for="Y"><?php echo nbs(
                                                                                    2
                                                                                ); ?> ชื่อผู้ประเมิน </label>
                                                </div>
