          ...
          <div class="card">
            <div class="card-body">
              ...
              <form>
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">ข้อมูลผลิตภัณฑ์ชุมชน</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">ภาษาท้องถิ่น</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control">
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    <label for="inputText" class="col-sm-2 col-form-label">ค่านิยม/ความเชื่อ</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control">
                    </div>
                </div>
              ...
              <form>
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">ศาสนา</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">ร้อยละ</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
              ...
              <form>
                ...
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">กลุ่มอาชีพ</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control">
                  </div>
                </div>
