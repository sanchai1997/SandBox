            ...
            <div class="col-lg-9">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="<?php echo base_url('update-school-contact/' . $SCHOOL->SchoolID); ?>" method="POST" id="School" enctype="multipart/form-data">
