            ...
            <div class="col-lg-9">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="<?php echo base_url('update-transcript-subject/' . $_GET['SchoolID'] . '/' . $_GET['StudentReferenceID'] . '/' . $_GET['EducationYear'] . '/' . $_GET['Semester'] . '/' . $_GET['GradeLevelCode'] . '/' . $_GET['StudentID'] . '/' . $_GET['TranscriptSeriesNumber'] . '/' . $_GET['TranscriptNumber'] . '/' . $_GET['SubjectEducationYear'] . '/' . $_GET['SubjectSemester']); ?>" method="POST" id="Transcript" enctype="multipart/form-data">
                          ...
                          AND SubjectEducationYear = ' . $_GET['SubjectEducationYear'] . '
                          AND SubjectSemester = ' . $_GET['SubjectSemester'] . '
