            ...
            <div class="col-lg-9">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="row g-3" action="<?php echo base_url('add-teacher-position/' . $_GET['TeacherID'] . '/' . $_GET['SchoolID'] . '/' . $_GET['EducationYear'] . '/' . $_GET['Semester'] . '/' . $_GET['PersonnelTypeCode'] . '/' . $_GET['PositionCode']); ?>" method="POST" id="Teacher" enctype="multipart/form-data">
