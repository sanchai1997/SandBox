...
<main id="main" class="main">
        ...
        <div class="col-lg-9">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <!-- start Form  -->
              <form class="row g-3" action="<?php echo base_url('add_kpi');?>" method="POST" name="addKPI" id="addKPI" enctype="multipart/form-data"> 
                ...
                <div class="col-md-16">
                  ...
                  <input type="text" class="form-control" name="SUBJECT_KPI_ID"id="SUBJECT_KPI_ID" placeholder="รหัสตัวชี้วัดรายวิชา" >
                ...
                <div class="col-md-16">
                  <div class="form-floating">
                  <textarea type="text" class="form-control" name="SUBJECT_KPI_DETAIL"id="SUBJECT_KPI_DETAIL" placeholder="รายละเอียดตัวชี้วัด" ></textarea>                  
 ...
 <!--
                <div class="col-md-16">
                  <div class="form-floating">
                  <textarea type="text" class="form-control" name="SUBJECT_LC_STD"id="SUBJECT_LC_STD" placeholder="สาระการเรียนรู้แกนกลาง" ></textarea>
  ...
  -->              
              ...
              <!-- End Form -->
                ...
                <div class="d-flex justify-content-between">
                  ...
                  <button type="button" class="btn btn-primary" onclick="return check(addKPI)">บันทึกข้อมูล</button>
                </div> 
               <!-- Modal -->
