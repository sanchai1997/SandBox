<main id="main" class="main">
    ...
    <div class="pagetitle">
        <div class="row">
            <div class="col-12">
                <h1>ผลประเมินคุณภาพผู้เรียน : ใบแสดงผลการศึกษาชุดที่
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?php echo base_url('delete-transcript-nt/'  . $_GET['SchoolID'] . '/' . $_GET['StudentReferenceID'] . '/' . $_GET['EducationYear'] . '/' . $_GET['Semester'] . '/' . $_GET['GradeLevelCode'] . '/' . $_GET['StudentID'] . '/' . $_GET['TranscriptSeriesNumber']  . '/' . $_GET['TranscriptNumber'] . '/' . $TRANSCRIPT_NT->NTEducationYear . '/' . $TRANSCRIPT_NT->NTSemester . '/' . $TRANSCRIPT_NT->NTGradeLevelCode); ?>" method="POST">
