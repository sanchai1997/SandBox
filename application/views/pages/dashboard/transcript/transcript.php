                ...
                <?php } else if (isset($_GET['SchoolID']) && empty($_GET['EducationYear']) && empty($_GET['Semester']) && empty($_GET['GradeLevelCode']) && !isset($_GET['ShowDetail'])) { ?>
                    ...
                    <table class="table table-borderless datatable">
                        ...
                        <tbody>
                            ...
                            GROUP BY EducationYear, Semester, GradeLevelCode ASC
                            ');
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="staticBackdropLabel"><i class="bi bi-file-earmark-text"></i> รายงานสมุดพก</h5>
                                </div>
                                <div class="modal-body">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr>
                                                <td scope="col">ปีการศึกษา</td>
                                                <td scope="col">ชั้นปี</td>
                                                <td scope="col" width="150px" style="text-align: center;">ดาวน์โหลด</td>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            WHERE StudentReferenceID = "' . $STUDENT->StudentReferenceID . '" AND DeleteStatus = 0
                                            AND FundamentalSubjectPassingCode = "1" AND LiteracyPassingCode = "1" AND AttributePassingCode = "1" AND ExtracurricularPassingCode = "1"
                                            ...
                                            ?>
                                                    <tr>
                                                        <td><?= $TRANSCRIPT->EducationYear ?></td>
                                                        <td><?= $TRANSCRIPT->GRADE_LEVEL_NAME ?></td>
                                                        <td style="text-align: center;"> <a href="transcript-booking-print?SchoolID=<?= $STUDENT->SchoolID ?>&&StudentReferenceID=<?= $STUDENT->StudentReferenceID ?>&&EducationYear=<?= $TRANSCRIPT->EducationYear ?>&&OldSchoolLastGradeLevelCode=<?= $TRANSCRIPT->OldSchoolLastGradeLevelCode ?>" target="_blank" class="btn btn-success"><i class="bi bi-download"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                }
                ...
                <table class="table table-borderless datatable">
                    ...
                    <tbody>
                        ...
                        $result = $this->db->query('SELECT * FROM TRANSCRIPT
                            ...
                            GROUP BY EducationYear, Semester, OldSchoolLastGradeLevelCode ASC
                            ');
                        $Count = 0;
                        foreach ($result->result() as $TRANSCRIPT) {
                            $Count++;
