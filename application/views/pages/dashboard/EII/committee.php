    ...
    <div class="pagetitle">
        <div class="row ">
            ...
            <?php switch ($page) {
                ...
                <?php break;
                case 'sh2': ?> <h1>ข้อมูลรายชื่อคณะกรรมการ</h1>
                <?php break;
                ...
                <div class="card-body">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                            <li>
                                <a class="dropdown-item" href="<?php echo site_url('Fm_committee_das_p1?page=sh1'); ?>">ข้อมูลอำนาจและหน้าที่ของคณะกรรมการขับเคลื่อน</a>
                            </li>
                        ...
                        <tbody>
                            ...
                            ");
                                    ...
                                    ?>
                                        ...
                                        <td style="text-align: center;"><a href="<?php echo site_url('Fm_committee_das_p2?page=sh2') ?>&&key=<?php echo $show->CommitteeAppointmentNumber ?>" class="btn btn-warning"><i class="bi bi-eye"></i></a></td>
                                        <!-- แก้ไขลบ -->
                                        <td style="text-align: center;">
                                            ...
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#del_committee<?php echo $show->Id; ?>">
                                                <i class="bi bi-trash"></i>
                                            </button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="del_committee<?php echo $show->Id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <h6 style="float: right; padding: 15px;" class="card-title"><a href="<?php echo site_url('cm_forms_p2?page=sh2'
                            ...
                            ");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!-- แก้ไขลบ -->
                                        <td style="text-align: center;">
                                            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#look2<?php echo $show_member->Id; ?>"><i class="bi bi-card-list"></i></button>
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#del_comm_member<?php echo $show_member->Id; ?>">
                                                <i class="bi bi-trash"></i>
                                            </button>
                                            <!-- Modal -->
                                            <div class="modal fade" id="del_comm_member<?php echo $show_member->Id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h6 class="modal-title" id="exampleModalLabel">
...
<?php if ($page == 'sh1') {  ?>
    ...
    ?>
        <div class="modal fade" id="look1<?php echo $show->Id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        ?>
                            <div class="row">
                                <div class="col">
                                    ...
                                    <p>
                                        <th scope="row " style="text-align: center;">
                                            <a href="<?php echo base_url('document') ?>/<?php echo $show->CommitteeAppointmentAttachmentURL; ?>" target="_blank"><i class="bi bi-file-text"></i></a>
                    ...
                    <div class="modal-body">
                        ...
                        ?>
                            <div class="row">
                                ...
                                <div class="col">
                                    <h6 class="fw-bold">
                                        ชื่อกรรมการและอนุกรรมการที่คณะกรรมการขับเคลื่อนพื้นที่นวัตกรรมการศึกษาแต่งตั้ง(ภาษาไทย)</h6>
                                    ...
                                    <h6 class="fw-bold">
                                        ชื่อกลางกรรมการและอนุกรรมการที่คณะกรรมการขับเคลื่อนพื้นที่นวัตกรรมการศึกษาแต่งตั้ง (ภาษาไทย)
                                    </h6>
                                    <p><?php echo $show->CommitteeMemberMiddleNameThai; ?></p>
                                    <h6 class="fw-bold">
                                        ชื่อกลางกรรมการและอนุกรรมการที่คณะกรรมการขับเคลื่อนพื้นที่นวัตกรรมการศึกษาแต่งตั้ง(ภาษาอังกฤษ)
                                    </h6>
                                    <p><?php echo $show->CommitteeMemberMiddleNameEnglish; ?></p>
                                    <h6 class="fw-bold">
                                        นามสกุลกรรมการและอนุกรรมการที่คณะกรรมการขับเคลื่อนพื้นที่นวัตกรรมการศึกษาแต่งตั้ง (ภาษาไทย)
                                    </h6>
                                    <p><?php echo $show->CommitteeMemberLastNameThai; ?></p>
                                    <h6 class="fw-bold">
                                        นามสกุลกรรมการและอนุกรรมการที่คณะกรรมการขับเคลื่อนพื้นที่นวัตกรรมการศึกษาแต่งตั้ง(ภาษาอังกฤษ)
                                    </h6>
                                ...
                                <div class="col">
                                    <h6 class="fw-bold">
                                        รหัสตำแหน่งกรรมการและอนุกรรมการที่คณะกรรมการขับเคลื่อนพื้นที่นวัตกรรมการศึกษาแต่งตั้ง</h6>
                                    <p><?php echo $shows->COMMITEE_POSITION_NAME; ?></p>
                                    <h6 class="fw-bold">
                                        ตำแหน่งในองค์กรของกรรมการและอนุกรรมการที่คณะกรรมการขับเคลื่อนพื้นที่นวัตกรรมการศึกษาแต่งตั้ง
                                    </h6>
