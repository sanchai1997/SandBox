...
<?php if ($page == 'sh1') { ?>
    ...
    foreach ($result->result() as $show) {
    ?>
        <div class="modal fade" id="das<?php echo $show->Id_in; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <div class="row my-2">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" disabled style="width: 100%; background-color: #fff; border: 1px solid #ced4da; border-radius: 0.25rem;"><?php echo $show->Abstract; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row my-2">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" disabled style="width: 100%; background-color: #fff; border: 1px solid #ced4da; border-radius: 0.25rem;"><?php echo $show->InnovationBenefit; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row m-2">
