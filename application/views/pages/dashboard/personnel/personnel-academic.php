    ...
    <div class="pagetitle">
        <div class="row">
            ...
            <div class="col-6" style="padding-right: 25px;">
                ...
                <a href="" style="float: right;" class="btn btn-sm btn-light" data-mdb-ripple-color="dark">ระดับการศึกษา</a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= DateThai($ACADEMIC->AcademicDate); ?></td>
                                <td style="text-align: center;"><?= DateThai($ACADEMIC->AdditionalDutyDate); ?></td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="<?php echo base_url('delete-academic/');
