                ...
                <div class="modal-body" style="padding-left: 60px; padding-top: 30px;">
                    <div class="row">
                        <div class="col-6" style="padding-bottom: 8px;">
                            ชื่อสถานศึกษา : <?= $model_school->NAME_TH; ?> ( <?= $model_school->NAME_EN; ?> )
                        </div>
                        <div class="col-6" style="padding-bottom: 8px;">
                            วันที่ก่อตั้ง : <?= DateThai($model_school->ESTABLISHED_DATE); ?>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6" style="padding-bottom: 8px;">
                        ...
                        <div class="col-6" style="padding-bottom: 8px;">
                            ...
                            switch ($model_school->SCHOOL_TYPE_CODE) {
                                case 1:
                                    echo "โรงเรียน ประเภทสามัญศึกษา";
                                    break;
                                case 2:
                                    echo "โรงเรียนเอกชนสามัญ (สามัญปกติ)";
                                    break;
                            }
                            ?>
                        </div>
                        ...
                        <div class="col-6" style="padding-bottom: 8px;">
                            ...
                            switch ($model_school->MUNICIPAL_CODE) {
                                ...
                                case 14:
                                    ...
                                    break;
                                case 16:
                                    echo "องค์การบริหารส่วนตำบล";
                                    break;
                                case 17:
                                    echo "องค์การบริหารส่วนจังหวัด";
                                    break;
                                case 99:
                                    echo "ไม่อยู่ในเขตเทศบาล";
                                    break;
                            }
                            ?>
                        </div>
                        ...
                        <div class="col-6" style="padding-bottom: 8px;">
                            ...
                            switch ($model_school->ELECTRIC_TYPE_CODES) {
                                case 99:
                                    ...
                                    break;
                                case 10:
                                    echo "มีไฟฟ้าจากหน่วยงานรัฐ-รัฐวิสาหกิจ";
                                    break;
                                case 11:
                                    echo "มีไฟฟ้าจากหน่วยงานรัฐ และเครื่องกำเนิดไฟฟ้า";
                                    break;
                                case 12:
                                    echo "มีไฟฟ้าจากเครื่องกำเนิดไฟฟ้าแสงอาทิตย์";
                                    break;
                                case 13:
                                    echo "มีไฟฟ้าจากเครื่องกำเนิดไฟฟ้าประเภทอื่น";
                                    break;
                            }
                            ?>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6" style="padding-bottom: 8px;">
                            ...
                            switch ($model_school->INTERNET_TYPE_CODES) {
                                case 99:
                                    ...
                                    break;
                                case 10:
                                    echo "มีการเชื่อมต่ออินเทอร์เน็ตด้วยวงจรเช่า Leased Line";
                                    break;
                                case 11:
                                    echo "มีการเชื่อมต่ออินเทอร์เน็ตด้วย ADSL (Broadband)";
                                    break;
                                case 12:
                                    echo "มีการเชื่อมต่ออินเทอร์เน็ตด้วยจานดาวเทียม";
                                    break;
                                case 13:
                                    echo "มีการเชื่อมต่ออินเทอร์เน็ตด้วย 3G 4G 5G WiMAX";
                                    break;
                                case 14:
                                    echo "มีการเชื่อมต่ออินเทอร์เน็ตด้วย Dial Line";
                                    break;
                                case 15:
                                    echo "มีการเชื่อมต่ออินเทอร์เน็ตประเภทอื่นๆ";
                                    break;
                                case 16:
                                    echo "มีการเชื่อมต่ออินเทอร์เน็ตด้วย Fiber Optic";
                                    break;
                            }
                            ?>
                        </div>
                        <div class="col-6" style="padding-bottom: 8px;">
                            ...
                            switch ($model_school->EDUCATION_CONTENTS) {
                                case 10:
                                    echo "มีวิทยุเพื่อการศึกษา";
                                    break;
                                case 11:
                                    echo "มีโทรทัศน์เพื่อการศึกษา";
                                    break;
                                case 12:
                                    echo "มีคอมพิวเตอร์เพื่อการศึกษา";
                                    break;
                                case 13:
                                    echo "มีระบบคอมพิวเตอร์ช่วยสอน (CAI)";
                                    break;
                                case 99:
                                    echo "ไม่ใช้สื่อการเรียนการสอน";
                                    break;
                            }
                            ?>
                        </div>
