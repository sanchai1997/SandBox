                ...
                <div class="row">
                    <div class="col">
                        <h5 class="card-title">รายละเอียดข้อมูล : <a href="school" class="btn btn-sm btn-light" data-mdb-ripple-color="dark">ข้อมูลสถานศึกษา</a>
                            <a href="school-classroom" class="btn btn-sm btn-light" data-mdb-ripple-color="dark">ข้อมูลห้องเรียน</a>
                            <a href="school-award" class="btn btn-sm btn-outline-secondary" active data-mdb-ripple-color="dark">ข้อมูลรางวัล</a>
                        </h5>
                    </div>
                    <div class="col">
                        <h5 style="float: right; padding: 15px;" class="card-title"><a href="forms-school-award" class="btn btn-success">เพิ่มข้อมูล</a></h5>
                    </div>
                </div>
