                ...
                <div class="card-body">
                    ...
                    <table class="table table-borderless datatable">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    <td style="text-align: center;"><img src="./assets/school/<?= $SCHOOL->ImageSchool; ?>" alt="" width="90px" height="80px"></td>
                        ...
                        <div class="row">
                            <?php if ($SCHOOL_DETAIL->ImageSchool != '') { ?>
                                <div class="col-2" style="padding-bottom: 8px; padding-left: 60px; padding-top: 0px;">
                                    <div class="card">
                                        <img style="text-align: center; padding: 15px;" src="./assets/school/<?= $SCHOOL_DETAIL->ImageSchool; ?>" alt="" width="100%" height="100%" style="padding-top: 20px;">
                                    </div>
                                </div>
                            <?php } else { ?>
