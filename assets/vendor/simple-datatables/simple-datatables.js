				...
				function (require, module, exports) {
					...
					const h = function (t) {
						...
						l = {
							...
							paging: !0,
							perPage: 25,
							perPageSelect: [25, 50, 75, 100, 150],
							nextPrev: !0,
							firstLast: !1,
							prevText: "&lsaquo;",
							nextText: "&rsaquo;",
							...
							labels: {
								...
								info: "แสดง {start} ถึง {end} จาก {rows} แถว",
							},
					...
					class o {
						...
						render(t) {
							...
							if (s.searchable) {
								const t = `<div class='dataTable-search' style="float: left; padding-left: 20px;" ><input class='dataTable-input' style="width: 300px;" placeholder='${s.labels.placeholder}' type='text'></div>`;
